...
`go get -u -v gopkg.in/trueanthem/goinsta.v2`
...
import (
	...
	"gopkg.in/trueanthem/goinsta.v2"
)
...
- [instagraph](https://github.com/trueanthem/instagraph)
...
```
$ go get -u github.com/trueanthem/goinsta/v2
```
